...
from fauzancart.models import Transaksi, DetailTransaksi
...
from fauzancart.forms import CartAddProductForm
from fauzancart.keranjang import Cart
import datetime
...
class KontakView(View):
    ...
    def post(self, request):
        ...
        no_whatsapp = request.POST.get('whatsapp')
        ...
        kontak = Kontak.objects.create(nama = nama, email = email, no_whatsapp=no_whatsapp, subject = subject, isi = pesan )
        kontak.save()
        context = {
            'judul': 'Halaman Kontak',
            'data': "",
...
class CheckoutView(View):
    ...
    def post(self, request):
        ...
        transaksi = Transaksi.objects.create(no_transaksi = no_transaksi, nama_depan = nama_depan, nama_belakang=nama_belakang, alamat = alamat, provinsi = provinsi, kabupaten = kabupaten, kecamatan = kecamatan, kode_post = kode_post, email = email, whatsapp = whatsapp, total_transaksi = grantotal )
        transaksi.save()
